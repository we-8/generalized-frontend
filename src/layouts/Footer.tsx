        ...
        <div className="app__footer-upper-section">
          <div className="app__footer-upper-elements">
            ...
            <p className="description">
              To deliver an outstanding quality service that: Customers are
              satisfied with and recommend to friends and family. We care your
              dreams.
            </p>
            <div className="social-media">
              <div className="social-media-icon-div">
                <a
                  href="https://www.instagram.com/ceylonrichproducts__?igsh=cDJ6b2pzMDgxZmNz"
                  target="_blank"
              ...
              <div className="social-media-icon-div">
                <a
                  href="https://www.tiktok.com/@ceylon_rich_products?_t=ZS-909QH04laEC&_r=1"
                  target="_blank"
                  rel="noopener noreferrer"
                >
              ...
              <div className="social-media-icon-div">
                <a
                  href="https://www.facebook.com/share/1BWsz1UhKu/"
                  target="_blank"
                  rel="noopener noreferrer"
                >
