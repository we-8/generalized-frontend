'use client'
import '../../styles/components-css/SimilarProducts.css';
...
const SimilarProducts = () => {
  ...
  return (
    <div className='app__similarProducts--main-div'>
      <TitleL title="You may also like"/>
      ...
      <Slider ref={sliderRef} {...settings}>
        {products.map((product, index) => (
          <div className='app__similarProducts--item-div' key={index}>
