...
const Herobanner: React.FC<imageProp> = ({
  backgroundImage,
  title,
  description,
}) => {
...
const Herobanner2: React.FC<imageProp> = ({
  backgroundImage,
  title,
  description,
}) => {
...
const Herobanner3: React.FC<imageProp> = ({
  backgroundImage,
  title,
  description,
}) => {
  return (
    <div className="app__herobanner--main-div ">
      ...
      >
        <div className="app__herobanner--overlay" /> {/* Overlay added */}
        <div className="app__herobanner--details">
          <div>
            <p className="herobanner__title2">{title}</p>
            <p className="herobanner_description">{description}</p>
...
export { Herobanner, Herobanner2, Herobanner3 };
